...
namespace ControleMedicamentos.ConsoleApp.Compartilhado
{
    public class TelaMenuPrincipal
    {
        ...
        public TelaMenuPrincipal(Notificador notificador)
        {
            ...
            telaCadastroRequisicao = new TelaCadastroRequisicao(notificador, repositorioRequisicao, 
                repositorioPaciente, repositorioMedicamento, telaCadastroPaciente, telaCadastroMedicamento);
        }
